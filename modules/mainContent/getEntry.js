...
const getPostItemsFromDb = async () => {
  ...
  const postInfo = `<p class="post-info">You've not added any post yet</p>`;
  output.innerHTML = userEntry.length == 0 ? postInfo : userEntryItems.join('');
...
export default getPostItemsFromDb;
